! function(e) {
    ...
    return e
        ...
        (function(t) {
            ...
            var r = n(11),
                ...
                x = "Data Consumed by Consumer",
                w = function(e, n, i) {
                    var o = t('<div class="text">' + e.ariaLabel + "</div>");
                    n.append(o);
                    var s = new r(o, e);
                    return t(s).on(r.Event.VALUE_SELECT, i), s
                },
                T = function(e) {
                ...
                S = function(e) {
                    this.model = e, this.node = l.querySelector("div").cloneNode(!0), this.$node = t(this.node), this.canvas = this.node.querySelector("canvas"), this.$canvas = t(this.canvas).find("p"), this.$graphic = this.$node.find(".graphic"), this.ctx = this.canvas.getContext("2d"), this.ctx.font = g + "px Arial, sans-serif", this.rects = T(this.canvas.width), this.speed = y["default"], this.isPlaying = !1, this.currentPosition = 0, this.voice = new o(5), document.body.appendChild(this.node), this.$startButtonNode = this.$node.find("._start"), this.$startButtonNode.click(this.start.bind(this)), this.$node.find("._reset").click(this.reset.bind(this)), this.$node.find("._faster").click(function() {
                        this.speed < y.max && this.speed++
                    }.bind(this)), this.$node.find("._slower").click(function() {
                        this.speed > y.min && this.speed--
                    }.bind(this)), this.$node.find(".applet").attr("aria-label", s.navigation);
                    var n = [function(t, n) {
                            e.setFileSize(n), this.reset()
                        }, function(t, n) {
                            e.setBufferSize(n), this.reset()
                        }],
                        i = this.$node.find(".comboboxes");
                    a.forEach(function(e, t) {
                        w(e, i, n[t].bind(this))
                    }, this), this.update(), this.updateAnimationAltText()
                };
            S.prototype.update = function() {
                this.clear(), this.drawBackground()
            }, S.prototype.step = function(e) {
                this.currentPosition = e, !this.isPlaying || this.isReset || this.model.isFinished() ? this.model.isFinished() && (this.update(), window.setTimeout(this.reset.bind(this), 2e3)) : (this.update(), requestAnimationFrame(this.step.bind(this, this.transmissionAnimation(e))))
            }, S.prototype.start = function() {
                this.isPlaying ? (this.isPlaying = !1, this.updateStartButton("resume"), this.step.bind(this), this.updatePausedAnimationAltText()) : (this.isPlaying = !0, this.updateStartButton("pause"), this.updateAnimationAltText(), this.isAnimationInProcess ? this.step(this.currentPosition) : (this.isReset = !1, this.model.canSend = !0, this.model.sendInProgress = !0, this.model.fullSendBuffer(), this.update(), window.setTimeout(this.step.bind(this, 0), 1e3)))
            }, S.prototype.drawHost = function(e) {
                var t = this.rects.hosts[e];
                this.ctx.textAlign = "center", this.ctx.fillStyle = u.black, this.ctx.fillText(t.outside.text, t.outside.centerX, g), this.ctx.strokeStyle = u.black, this.ctx.lineWidth = c.stroke, this.ctx.strokeRect(t.outside.x, t.outside.y, t.outside.width, t.outside.height), this.ctx.strokeRect(t.buffer.x, t.buffer.y, t.buffer.width, t.buffer.height), this.ctx.lineWidth = 1, this.ctx.strokeRect(t.inside.x, t.inside.y, t.inside.width, t.inside.height)
            }, S.prototype.drawCable = function() {
                this.ctx.strokeStyle = u.black, this.ctx.lineWidth = c.stroke, this.ctx.strokeRect(this.rects.cable.x, this.rects.cable.y, this.rects.cable.width, this.rects.cable.height)
            }, S.prototype.drawMessageBoxes = function() {
                var e, t = "",
                    n = "";
                this.model.sendInProgress && (t = k(this.model.requestedData, !0), n = "SEQ = " + k(this.model.getRecievedAmount()), e = this.rects.messageBox.ySend), this.model.receiveInProgress && (t = "ACK = " + k(this.model.getRecievedAmount()), n = "WIN = " + k(this.model.requestedData), e = this.rects.messageBox.yRecieve), this.drawMessageBox(e, t, n)
            }, S.prototype.drawMessageBox = function(e, t, n) {
                var i = e + (h.height + g) / 2;
                this.ctx.textAlign = "center", this.ctx.fillStyle = u.black, this.ctx.fillText(t, this.rects.messageBox.beginCenterX, i), this.ctx.fillText(n, this.rects.messageBox.endCenterX, i), this.ctx.strokeStyle = u.black, this.ctx.lineWidth = c.stroke, this.ctx.strokeRect(this.rects.messageBox.x, e, this.rects.messageBox.width, this.rects.messageBox.height), this.ctx.beginPath(), this.ctx.moveTo(this.rects.messageBox.centerX, e), this.ctx.lineTo(this.rects.messageBox.centerX, e + h.height), this.ctx.stroke()
            }, S.prototype.drawConsumedText = function() {
                this.ctx.textAlign = "center", this.ctx.fillStyle = u.red, this.ctx.fillText(x, this.rects.messageBox.centerX, this.rects.hosts[0].outside.y + g / 2)
                ...
                if (0 != t) {
                    ...
                    this.ctx.fillStyle = u.blue, this.ctx.fillRect(n.buffer.x, n.buffer.y, n.buffer.width * t, n.buffer.height)
                }
                ...
                0 != t && (i = n.inside.height * t, r = (this.model.fileSize * t).toFixed(0), o = n.inside.y + n.inside.height - i), this.ctx.fillStyle = u.blue, this.ctx.textAlign = "right", this.ctx.fillText(r + v, n.outside.centerX - 5, o + g / 2 - c.stroke), this.ctx.fillRect(n.inside.x, o, n.inside.width, i)
            }, S.prototype.drawBackground = function() {
                this.drawHost(0), this.drawHost(1), this.drawCable(), this.colorBuffer(0), this.colorBuffer(1), this.colorInsideHost(0), this.colorInsideHost(1), this.drawMessageBoxes(), this.model.justConsumed && this.drawConsumedText()
            }, S.prototype.clear = function() {
                this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height)
            }, S.prototype.transmissionAnimation = function(e) {
                if (void 0 != e) {
                    var t = 0;
                    return this.model.sendInProgress && !this.model.finished ? t = this.sendAnimation(e) : this.model.receiveInProgress && (t = this.recieveAnimation(e)), t
                }
            }, S.prototype.sendAnimation = function(e) {
                e = e || this.rects.cable.x, this.isAnimationInProcess = !0, this.model.send(), e < this.rects.hosts[1].outside.x - p ? this.isPlaying && (e += this.speed) : (this.isAnimationInProcess = !1, this.model.finishSend());
                var t = e + c.stroke / 2,
                ...
                return this.ctx.fillStyle = u.blue, this.ctx.fillRect(t, n, p - r, i), e
            }, S.prototype.recieveAnimation = function(e) {
                e = e || this.rects.hosts[1].outside.x, this.isAnimationInProcess = !0, e > this.rects.cable.x + p ? this.isPlaying && (e -= this.speed) : (this.isAnimationInProcess = !1, this.model.finishReceive());
                var t = e + c.stroke / 2 - p,
                    n = this.rects.cable.y + c.stroke / 2,
                    i = this.rects.cable.height - c.stroke,
                    r = t <= this.rects.cable.x ? this.rects.cable.x - t : 0;
                return this.ctx.fillStyle = u.red, this.ctx.fillRect(t + r, n, p, i), e
            }, S.prototype.reset = function() {
                this.isReset = !0, this.updateStartButton("start"), this.isPlaying = !1, this.isAnimationInProcess = !1, this.currentPosition = 0, this.speed = y["default"], this.model.reset(), this.updateAnimationAltText(), this.update()
            }, S.prototype.updateStartButton = function(e) {
                this.$startButtonNode.text(b[e]), this.$startButtonNode.attr("aria-label", s.buttons[e])
            }, S.prototype.updateAnimationAltText = function() {
                var e = s.animation,
                    t = e.initial,
                    n = this.model.isBufferSmall() ? e.smallBuffer : e.bigBuffer;
                n = n.replace(e.placeholders.fileSize, this.model.fileSize), n = n.replace(e.placeholders.bufferSize, this.model.bufferSize), this.$canvas.text(t + n), this.$graphic.attr("aria-label", t + n)
                ...
                t = t.replace(e.placeholders.fileSize, this.model.fileSize), t = t.replace(e.placeholders.bufferSize, this.model.bufferSize), t = t.replace(e.placeholders.hostAData, i), t = t.replace(e.placeholders.sendBuffer, this.model.sendBuffer), t = t.replace(e.placeholders.hostBData, this.model.consumedData), t = t.replace(e.placeholders.receiveBuffer, this.model.receiveBuffer), n = n.replace(e.placeholders.packetSize, this.model.requestedData), n = n.replace(e.placeholders.seq, r), n = n.replace(e.placeholders.ack, r), this.voice.speak(t + n)
            }, e.exports = S
        }).call(t, n(3))
    }, function(e, t, n) {
        var i, r;
        ...
        ! function(t, n) {
            ...
            function h(e, t, n, i) {
                var r, o = 1,
                    ...
                    c = (le.cssNumber[t] || "px" !== l && +u) && qe.exec(le.css(e, t));
                if (c && c[3] !== l) {
                    l = l || c[3], n = n || [], c = +u || 1;
            ...
            function m(e, t, n, i, r) {
                for (var o, s, a, u, l, c, f = t.createDocumentFragment(), d = [], h = 0, m = e.length; m > h; h++)
                    ...
                    for (s = s || f.appendChild(t.createElement("div")), a = (Ie.exec(o) || ["", ""])[1].toLowerCase(), u = Fe[a] || Fe._default, s.innerHTML = u[1] + le.htmlPrefilter(o) + u[2], c = u[0]; c--;) s = s.lastChild;
                    le.merge(d, s.childNodes), s = f.firstChild, s.textContent = ""
                } else d.push(t.createTextNode(o));
                for (f.textContent = "", h = 0; o = d[h++];)
                    if (i && le.inArray(o, i) > -1) r && r.push(o);
                    else if (l = le.contains(o.ownerDocument, o), s = p(f.appendChild(o), "script"), l && g(s), n)
            ...
            function A(e, t, n, i) {
                ...
                var r, o, s, a, u, l, c = 0,
                    ...
                    h = t[0],
                    g = le.isFunction(h);
                if (g || f > 1 && "string" == typeof h && !ae.checkClone && Ve.test(h)) return e.each(function(r) {
                    var o = e.eq(r);
                    g && (t[0] = h.call(this, r, o.html())), A(o, t, n, i)
                });
                if (f && (r = m(t, e[0].ownerDocument, !1, e, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
                    for (s = le.map(p(r, "script"), T), a = s.length; f > c; c++) u = r, c !== d && (u = le.clone(u, !0, !0), a && le.merge(s, p(u, "script"))), n.call(e[c], u, c);
                    if (a)
                        for (l = s[s.length - 1].ownerDocument, le.map(s, k), c = 0; a > c; c++) u = s[c], Oe.test(u.type || "") && !De.access(u, "globalEval") && le.contains(l, u) && (u.src ? le._evalUrl && le._evalUrl(u.src) : le.globalEval(u.textContent.replace(Ye, "")))
                }
                return e
            }
            ...
            function D(e) {
                var t = Z,
                    n = Qe[e];
                return n || (n = N(e, t), "none" !== n && n || (Ge = (Ge || le("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ge[0].contentDocument, t.write(), t.close(), n = N(e, t), Ge.detach()), Qe[e] = n), n
            }

            function j(e, t, n) {
                var i, r, o, s, a = e.style;
                return n = n || et(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || le.contains(e.ownerDocument, e) || (s = le.style(e, t)), n && !ae.pixelMarginRight() && Ze.test(s) && Je.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o), void 0 !== s ? s + "" : s
            }
            ...
            function q(e, t, n, i, r) {
                for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n && (s += le.css(e, n + He[o], !0, r)), i ? ("content" === n && (s -= le.css(e, "padding" + He[o], !0, r)), "margin" !== n && (s -= le.css(e, "border" + He[o] + "Width", !0, r))) : (s += le.css(e, "padding" + He[o], !0, r), "padding" !== n && (s += le.css(e, "border" + He[o] + "Width", !0, r)));
                return s
            }
            ...
            function H(e, t, n) {
                ...
                if (0 >= r || null == r) {
                    if (r = j(e, t, o), (0 > r || null == r) && (r = e.style[t]), Ze.test(r)) return r;
            ...
            function R(e, t) {
                for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (o[s] = De.get(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Re(i) && (o[s] = De.access(i, "olddisplay", D(i.nodeName)))) : (r = Re(i), "none" === n && r || De.set(i, "olddisplay", r ? n : le.css(i, "display"))));
            ...
            function O(e, t) {
                ...
                for (t = t ? 1 : 0; 4 > i; i += 2 - t) n = He[i], r["margin" + n] = r["padding" + n] = e;
            ...
            function $(e, t, n) {
                ...
                })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], l = le.css(e, "display"), c = "none" === l ? De.get(e, "olddisplay") || D(e.nodeName) : l, "inline" === c && "none" === le.css(e, "float") && (h.display = "inline-block")), n.overflow && (h.overflow = "hidden", f.always(function() {
                ...
                if (le.isEmptyObject(d)) "inline" === ("none" === l ? D(e.nodeName) : l) && (h.display = l);
                else {
                    g ? "hidden" in g && (p = g.hidden) : g = De.access(e, "fxshow", {}), o && (g.hidden = !p), p ? le(e).show() : f.done(function() {
                        le(e).hide()
                    }), f.done(function() {
                        var t;
                        De.remove(e, "fxshow");
                    ...
                    for (i in d) s = F(p ? g[i] : 0, i, f), i in g || (g[i] = s.start, p && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
                }
            }
            ...
            function W(e, t, n) {
                var i, r, o = 0,
                    ...
                    u = function() {
                        if (r) return !1;
                        for (var t = ut || I(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, o = 1 - i, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
                ...
                for (M(c, l.opts.specialEasing); s > o; o++)
                    if (i = W.prefilters[o].call(l, e, c, l.opts)) return le.isFunction(i.stop) && (le._queueHooks(l.elem, l.opts.queue).stop = le.proxy(i.stop, i)), i;
                return le.map(c, F, l), le.isFunction(l.opts.start) && l.opts.start.call(e, l), le.fx.timer(le.extend(u, {
                    elem: e,
                    anim: l,
                    queue: l.opts.queue
            ...
            var pe =
                function(e) {
                    function t(e, t, n, i) {
                        ...
                        if (!i && ((t ? t.ownerDocument || t : F) !== L && B(t), t = t || L, q)) {
                            if (11 !== g && (l = ve.exec(e)))
                                if (r = l[1]) {
                                    if (9 === g) {
                                    ...
                                    if ((r = l[3]) && w.getElementsByClassName && t.getElementsByClassName) return J.apply(n, t.getElementsByClassName(r)), n
                                }
                            if (w.qsa && !X[e + " "] && (!H || !H.test(e))) {
                                if (1 !== g) p = t, h = e;
                                else if ("object" !== t.nodeName.toLowerCase()) {
                                    for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") : t.setAttribute("id", a = O), f = C(e), o = f.length, u = de.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = u + " " + d(f[o]);
                    ...
                    function h(e, t, n) {
                        ...
                        return t.first ? function(t, n, o) {
                            ...
                            if (s) {
                                ...
                                for (; t = t[i];)
                                    if (1 === t.nodeType || r) {
                                        if (l = t[O] || (t[O] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (a = u[i]) && a[0] === $ && a[1] === o) return c[2] = a[2];
                    ...
                    function v(e, t, n, r, o, s) {
                        return r && !r[O] && (r = v(r)), o && !o[O] && (o = v(o, s)), i(function(i, s, a, u) {
                            var l, c, f, d = [],
                                ...
                                b = n ? o || (i ? e : p || r) ? [] : s : y;
                            if (n && n(y, b, a, u), r)
                                for (l = m(b, h), r(l, [], a, u), c = l.length; c--;)(f = l[c]) && (b[h[c]] = !(y[h[c]] = f));
                            if (i) {
                                if (o || e) {
                                    if (o) {
                                    ...
                                    for (c = b.length; c--;)(f = b[c]) && (l = o ? ee(i, f) : d[c]) > -1 && (i[l] = !(s[l] = f))
                                }
                            } else b = m(b === s ? b.splice(p, b.length) : b), o ? o(null, s, b, u) : J.apply(s, b)
                        })
                    }
                    ...
                    function y(e) {
                        for (var t, n, i, r = e.length, o = T.relative[e[0].type], s = o || T.relative[" "], a = o ? 1 : 0, u = h(function(e) {
                            ...
                            if (n = T.relative[e[a].type]) c = [h(p(c), n)];
                            else {
                        ...
                        var r = n.length > 0,
                            ...
                            s = function(i, s, a, u, l) {
                                ...
                                for (l && (N = s === L || s || l); p !== w && null != (c = b[p]); p++) {
                                    if (o && c) {
                                        for (f = 0, s || c.ownerDocument === L || (B(c), a = !q); d = e[f++];)
                                            if (d(c, s || L, a)) {
                                                u.push(c);
                                                break
                                            }
                                ...
                                if (h += p, r && p !== h) {
                                    ...
                                    J.apply(u, v), l && !i && v.length > 0 && h + n.length > 1 && t.uniqueSort(u)
                                }
                                return l && ($ = x, N = y), g
                            };
                        return r ? i(s) : s
                    }
                    var x, w, T, k, S, C, A, E, N, D, j, B, L, P, q, H, R, z, I, O = "sizzle" + 1 * new Date,
                        F = e.document,
                        $ = 0,
                        M = 0,
                        W = n(),
                    ...
                    w = t.support = {}, S = t.isXML = function(e) {
                        ...
                        return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, P = L.documentElement, q = !S(L), (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = r(function(e) {
                        ...
                        }, R = [], H = [], (w.qsa = me.test(L.querySelectorAll)) && (r(function(e) {
                            ...
                            w.disconnectedMatch = z.call(e, "div"), z.call(e, "[s!='']:x"), R.push("!=", oe)
                        }), H = H.length && new RegExp(H.join("|")), R = R.length && new RegExp(R.join("|")), t = me.test(P.compareDocumentPosition), I = t || me.test(P.contains) ? function(e, t) {
                            ...
                            return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === F && I(F, e) ? -1 : t === L || t.ownerDocument === F && I(F, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
                        } : function(e, t) {
                            if (e === t) return j = !0, 0;
                            var n, i = 0,
                                r = e.parentNode,
                        ...
                        if ((e.ownerDocument || e) !== L && B(e), n = n.replace(ce, "='$1']"), w.matchesSelector && q && !X[n + " "] && (!R || !R.test(n)) && (!H || !H.test(n))) try {
                            var i = z.call(e, n);
                                ...
                                return 1 === i && 0 === r ? function(e) {
                                    ...
                                    if (m) {
                                        ...
                                        if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                            for (d = m, f = d[O] || (d[O] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), l = c[e] || [], h = l[0] === $ && l[1], b = h && l[2], d = h && m.childNodes[h]; d = ++h && d && d[g] || (b = h = 0) || p.pop();)
                                                if (1 === d.nodeType && ++b && d === t) {
                                                    c[e] = [$, h, b];
                                                    break
                                                }
                                        } else if (y && (d = t, f = d[O] || (d[O] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), l = c[e] || [], h = l[0] === $ && l[1], b = h), b === !1)
                                            for (;
                                                (d = ++h && d && d[g] || (b = h = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && (f = d[O] || (d[O] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), c[e] = [$, b]), d !== t)););
                    ...
                    return f.prototype = T.filters = T.pseudos, T.setFilters = new f, C = t.tokenize = function(e, n) {
                        ...
                        return (l || A(e, f))(i, t, !q, n, !t || ye.test(e) && c(t.parentNode) || t), n
                    }, w.sortStable = O.split("").sort(U).join("") === O, w.detectDuplicates = !!j, B(), w.sortDetached = r(function(e) {
            ...
            le.fn.extend({
                ...
                le.fn[e] = function(n, i) {
                    ...
                    return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = le.filter(i, r)), this.length > 1 && (Se[e] || le.uniqueSort(r), ke.test(e) && r.reverse()), this.pushStack(r)
                }
            });
            var Ce = /\S+/g;
            le.Callbacks = function(e) {
                ...
                when: function(e) {
                    var t, n, i, r = 0,
                        ...
                        l = function(e, n, i) {
                            return function(r) {
                                n[e] = this, i[e] = arguments.length > 1 ? ee.call(arguments) : r, i === t ? u.notifyWith(n, i) : --a || u.resolveWith(n, i)
                            }
                        };
                    if (s > 1)
                        for (t = new Array(s), n = new Array(s), i = new Array(s); s > r; r++) o[r] && le.isFunction(o[r].promise) ? o[r].promise().progress(l(r, n, t)).done(l(r, i, o)).fail(u.reject) : --a;
            ...
            le.fn.ready = function(e) {
                ...
                ready: function(e) {
                    (e === !0 ? --le.readyWait : le.isReady) || (le.isReady = !0, e !== !0 && --le.readyWait > 0 || (Ae.resolveWith(Z, [le]), le.fn.triggerHandler && (le(Z).triggerHandler("ready"), le(Z).off("ready"))))
                }
            }), le.ready.promise = function(e) {
                return Ae || (Ae = le.Deferred(), "complete" === Z.readyState || "loading" !== Z.readyState && !Z.documentElement.doScroll ? n.setTimeout(le.ready) : (Z.addEventListener("DOMContentLoaded", c), n.addEventListener("load", c))), Ae.promise(e)
            }, le.ready.promise();
            ...
            le.extend({
                ...
                data: function(e, t) {
                    ...
                    if (void 0 === e) {
                        if (this.length && (r = je.get(o), 1 === o.nodeType && !De.get(o, "hasDataAttrs"))) {
                            for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = le.camelCase(i.slice(5)), d(o, i, r[i])));
                    ...
                    return "object" == typeof e ? this.each(function() {
                        ...
                        var n, i;
                        if (o && void 0 === t) {
                            if (n = je.get(o, e) || je.get(o, e.replace(Le, "-$&").toLowerCase()), void 0 !== n) return n;
                            if (i = le.camelCase(e), n = je.get(o, i), void 0 !== n) return n;
                ...
                queue: function(e, t, n) {
                    var i;
                    return e ? (t = (t || "fx") + "queue", i = De.get(e, t), n && (!i || le.isArray(n) ? i = De.access(e, t, le.makeArray(n)) : i.push(n)), i || []) : void 0
                },
                ...
                promise: function(e, t) {
                    ...
                    for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) n = De.get(o[s], e + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
            ...
            le.event = {
                ...
                add: function(e, t, n, i, r) {
                    ...
                    if (m)
                        for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = le.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                                return "undefined" != typeof le && le.event.triggered !== t.type ? le.event.dispatch.apply(e, arguments) : void 0
                            }), t = (t || "").match(Ce) || [""], l = t.length; l--;) a = _e.exec(t[l]) || [], h = g = a[1], p = (a[2] || "").split(".").sort(), h && (f = le.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = le.event.special[h] || {}, c = le.extend({
                            type: h,
                            origType: g,
                            data: i,
                            handler: n,
                            ...
                            namespace: p.join(".")
                        }, o), (d = u[h]) || (d = u[h] = [], d.delegateCount = 0, f.setup && f.setup.call(e, i, p, s) !== !1 || e.addEventListener && e.addEventListener(h, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), le.event.global[h] = !0)
                },
                remove: function(e, t, n, i, r) {
                    var o, s, a, u, l, c, f, d, h, p, g, m = De.hasData(e) && De.get(e);
                    if (m && (u = m.events)) {
                        for (t = (t || "").match(Ce) || [""], l = t.length; l--;)
                            if (a = _e.exec(t[l]) || [], h = g = a[1], p = (a[2] || "").split(".").sort(), h) {
                                for (f = le.event.special[h] || {}, h = (i ? f.delegateType : f.bindType) || h, d = u[h] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(o, 1),
                                    c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
                                s && !d.length && (f.teardown && f.teardown.call(e, p, m.handle) !== !1 || le.removeEvent(e, h, m.handle), delete u[h])
                            } else
                                for (h in u) le.event.remove(e, h + t[l], n, i, !0);
                    ...
                    if (a && u.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                        for (; u !== this; u = u.parentNode || this)
                            if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                                for (i = [], n = 0; a > n; n++) o = t[n], r = o.selector + " ", void 0 === i[r] && (i[r] = o.needsContext ? le(r, this).index(u) > -1 : le.find(r, this, null, [u]).length), i[r] && i.push(o);
                                i.length && s.push({
                                    elem: u,
                                    handlers: i
                                })
                ...
                fix: function(e) {
                    ...
                    var t, n, i, r = e.type,
                        o = e,
                        s = this.fixHooks[r];
                    for (s || (this.fixHooks[r] = s = We.test(r) ? this.mouseHooks : Me.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new le.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
            ...
            le.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    if (!(ae.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || le.isXMLDoc(e)))
                        for (s = p(a), o = p(e), i = 0, r = o.length; r > i; i++) C(o[i], s[i]);
                    if (t)
                        if (n)
                            for (o = o || p(e), s = s || p(a), i = 0, r = o.length; r > i; i++) S(o[i], s[i]);
                        else S(e, a);
                    return s = p(a, "script"), s.length > 0 && g(s, !u && p(e, "script")), a
                },
            ...
            le.extend({
                ...
                style: function(e, t, n, i) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var r, o, s, a = le.camelCase(t),
                            u = e.style;
                        return t = le.cssProps[a] || (le.cssProps[a] = L(a) || a), s = le.cssHooks[t] || le.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t] : (o = typeof n, "string" === o && (r = qe.exec(n)) && r[1] && (n = h(e, t, r), o = "number"), null != n && n === n && ("number" === o && (n += r && r[3] || (le.cssNumber[a] ? "" : "px")), ae.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (u[t] = n)), void 0)
                    }
                },
                css: function(e, t, n, i) {
                    var r, o, s, a = le.camelCase(t);
                    return t = le.cssProps[a] || (le.cssProps[a] = L(a) || a), s = le.cssHooks[t] || le.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = j(e, t, i)), "normal" === r && t in ot && (r = ot[t]), "" === n || n ? (o = parseFloat(r), n === !0 || isFinite(o) ? o || 0 : r) : r
                }
                ...
                le.cssHooks[t] = {
                    ...
                    set: function(e, n, i) {
                        var r, o = i && et(e),
                            s = i && q(e, t, i, "border-box" === le.css(e, "boxSizing", !1, o), o);
                        return s && (r = qe.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = le.css(e, t)), P(e, n, s)
                    }
                }
                ...
                le.cssHooks[e + t] = {
                    expand: function(n) {
                        for (var i = 0, r = {}, o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + He[i] + t] = o[i] || o[i - 2] || o[0];
                        return r
                    }
            ...
            le.fn.extend({
                ...
                attr: function(e, t, n) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o) return "undefined" == typeof e.getAttribute ? le.prop(e, t, n) : (1 === o && le.isXMLDoc(e) || (t = t.toLowerCase(), r = le.attrHooks[t] || (le.expr.match.bool.test(t) ? dt : void 0)), void 0 !== n ? null === n ? void le.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = le.find.attr(e, t), null == i ? void 0 : i))
                },
                attrHooks: {
                    type: {
                        set: function(e, t) {
            ...
            le.fn.extend({
                addClass: function(e) {
                    ...
                    if ("string" == typeof e && e)
                        for (t = e.match(Ce) || []; n = this[u++];)
                            if (r = _(n), i = 1 === n.nodeType && (" " + r + " ").replace(mt, " ")) {
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : le.isFunction(e) ? this.each(function(n) {
                        ...
                        else void 0 !== e && "boolean" !== n || (t = _(this), t && De.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : De.get(this, "__className__") || ""))
                    })
                },
                hasClass: function(e) {
                    var t, n, i = 0;
                    for (t = " " + e + " "; n = this[i++];)
                        if (1 === n.nodeType && (" " + _(n) + " ").replace(mt, " ").indexOf(t) > -1) return !0;
                    return !1
                }
            });
            var vt = /\r/g,
                    ...
                    select: {
                        get: function(e) {
                            for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || 0 > r, s = o ? null : [], a = o ? r + 1 : i.length, u = 0 > r ? a : o ? r : 0; a > u; u++)
                                if (n = i[u], (n.selected || u === r) && (ae.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !le.nodeName(n.parentNode, "optgroup"))) {
            ...
            le.extend(le.event, {
                trigger: function(e, t, i, r) {
                    var o, s, a, u, l, c, f, d = [i || Z],
                        h = se.call(e, "type") ? e.type : e,
                        p = se.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (s = a = i = i || Z, 3 !== i.nodeType && 8 !== i.nodeType && !bt.test(h + le.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), l = h.indexOf(":") < 0 && "on" + h, e = e[le.expando] ? e : new le.Event(h, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : le.makeArray(t, [e]), f = le.event.special[h] || {}, r || !f.trigger || f.trigger.apply(i, t) !== !1)) {
                        if (!r && !f.noBubble && !le.isWindow(i)) {
                            for (u = f.delegateType || h, bt.test(u + h) || (s = s.parentNode); s; s = s.parentNode) d.push(s), a = s;
                            a === (i.ownerDocument || Z) && d.push(a.defaultView || a.parentWindow || n)
                        }
                        for (o = 0;
                            (s = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? u : f.bindType || h, c = (De.get(s, "events") || {})[e.type] && De.get(s, "handle"), c && c.apply(s, t), c = l && s[l], c && c.apply && Ne(s) && (e.result = c.apply(s, t), e.result === !1 && e.preventDefault());
                        return e.type = h, r || e.isDefaultPrevented() || f._default && f._default.apply(d.pop(), t) !== !1 || !Ne(i) || l && le.isFunction(i[h]) && !le.isWindow(i) && (a = i[l], a && (i[l] = null), le.event.triggered = h, i[h](), le.event.triggered = void 0, a && (i[l] = a)), e.result
                    }
                },
            ...
            Lt.href = xt.href, le.extend({
                ...
                ajax: function(e, t) {
                    function i(e, t, i, a) {
                        var l, f, y, b, w, k = t;
                        2 !== x && (x = 2, u && n.clearTimeout(u), r = void 0, s = a || "", T.readyState = e > 0 ? 4 : 0, l = e >= 200 && 300 > e || 304 === e, i && (b = K(d, T, i)), b = Y(d, b, T, l), l ? (d.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (le.lastModified[o] = w), w = T.getResponseHeader("etag"), w && (le.etag[o] = w)), 204 === e || "HEAD" === d.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = b.state, f = b.data, y = b.error, l = !y)) : (y = k, !e && k || (k = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (t || k) + "", l ? g.resolveWith(h, [f, k, T]) : g.rejectWith(h, [T, k, y]), T.statusCode(v), v = void 0, c && p.trigger(l ? "ajaxSuccess" : "ajaxError", [T, d, l ? f : y]), m.fireWith(h, [T, k]), c && (p.trigger("ajaxComplete", [T, d]), --le.active || le.event.trigger("ajaxStop")))
                    }
                    "object" == typeof e && (t = e, e = void 0), t = t || {};
                    var r, o, s, a, u, l, c, f, d = le.ajaxSetup({}, t),
                        h = d.context || d,
                    ...
                    if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, d.url = ((e || d.url || xt.href) + "").replace(kt, "").replace(Nt, xt.protocol + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = le.trim(d.dataType || "*").toLowerCase().match(Ce) || [""], null == d.crossDomain) {
                        l = Z.createElement("a");
                        try {
                    ...
                    if (d.data && d.processData && "string" != typeof d.data && (d.data = le.param(d.data, d.traditional)), U(Dt, d, t, T), 2 === x) return T;
                    c = le.event && d.global, c && 0 === le.active++ && le.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Et.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Tt.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = St.test(o) ? o.replace(St, "$1_=" + wt++) : o + (Tt.test(o) ? "&" : "?") + "_=" + wt++)), d.ifModified && (le.lastModified[o] && T.setRequestHeader("If-Modified-Since", le.lastModified[o]), le.etag[o] && T.setRequestHeader("If-None-Match", le.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && T.setRequestHeader("Content-Type", d.contentType), T.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : d.accepts["*"]);
                    ...
                    if (r = U(jt, d, t, T)) {
                        if (T.readyState = 1, c && p.trigger("ajaxSend", [T, d]), 2 === x) return T;
            ...
            ae.cors = !!Ot && "withCredentials" in Ot, ae.ajax = Ot = !!Ot, le.ajaxTransport(function(e) {
                ...
                return ae.cors || Ot && !e.crossDomain ? {
                    send: function(r, o) {
                        ...
                        t = function(e) {
                            return function() {
                                t && (t = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(It[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                    binary: a.response
                                } : {
                                    text: a.responseText
            ...
            le.ajaxSetup({
                ...
                return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = le.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace($t, "$1" + r) : e.jsonp !== !1 && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            ...
            le.fn.load = function(e, t, n) {
                ...
                setOffset: function(e, t, n) {
                    var i, r, o, s, a, u, l, c = le.css(e, "position"),
                        f = le(e),
                        d = {};
                    "static" === c && (e.style.position = "relative"), a = f.offset(), o = le.css(e, "top"), u = le.css(e, "left"), l = ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1, l ? (i = f.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(u) || 0), le.isFunction(t) && (t = t.call(e, n, le.extend({}, a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + r), "using" in t ? t.using.call(e, d) : f.css(d)
                }
            }, le.fn.extend({
                offset: function(e) {
                    ...
                    var t, n, i = this[0],
                        ...
                        o = i && i.ownerDocument;
                    if (o) return t = o.documentElement, le.contains(t, i) ? (r = i.getBoundingClientRect(), n = Q(o), {
                ...
                le.cssHooks[t] = B(ae.pixelPosition, function(e, n) {
                    return n ? (n = j(e, t), Ze.test(n) ? le(e).position()[t] + "px" : n) : void 0
                })
            }), le.each({
                Height: "height",
                Width: "width"
            ...
            return le.noConflict = function(e) {
                return n.$ === le && (n.$ = _t), e && n.jQuery === le && (n.jQuery = Wt), le
            }, o || (n.jQuery = n.$ = le), le
        })
    }, function(e, t) {
        "use strict";
    ...
    function(e, t, n) {
        ...
        function l(e, t) {
            ...
            if (t.singleton) {
                var o = y++;
                n = v || (v = a(t)), i = c.bind(null, n, o, !1), r = c.bind(null, n, o, !0)
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = u(t), i = d.bind(null, n), r = function() {
                s(n), n.href && URL.revokeObjectURL(n.href)
            }) : (n = a(t), i = f.bind(null, n), r = function() {
                s(n)
            });
            return i(e),
                function(t) {
    ...
    [20, 10],
    function(e, t, n) {
        t = e.exports = n(7)(), t.push([e.id, "body{font-family:Arial,sans-serif}.header,h1{color:#101027;font-size:200%;font-weight:400;margin:.67em 0}.focusable,canvas{border:3px solid transparent}.focusable:focus,button:focus,canvas:focus{outline:none;border:3px dotted #000}.text,p{font-size:100%;margin:1em 0}button{font-size:80%;height:25px;background:linear-gradient(#fff,#f0f0f0);border:1px solid #adadad;box-sizing:border-box}button:disabled{background:#d3d3d3;border:1px solid #bcbcbc}button::-moz-focus-inner{border:0}.navigation{width:0;height:0;padding:0;margin:0;overflow:hidden}", ""])
    },
    function(e, t, n) {
        (function(t, i) {
            ...
            var r = {
                ...
                o = function(e, t) {
                    this.$select = i('<select aria-label="' + t.ariaLabel + '" class="combobox"></select>'), this.options = t;
                    ...
                    this.selectedValue = this.getSelectedValue(), this.$select.change(function(e) {
                        ...
                        t !== this.selectedValue && (this.selectedValue = t, i(this).trigger(r.VALUE_SELECT, t))
    ...
    function(e, t, n) {
        t = e.exports = n(7)(), t.push([e.id, ".combobox{height:25px;font-size:90%}.combobox:focus{outline:none;border:3px dotted #000}", ""])
    },
    function(e, t, n) {
        (function(t) {
            var n = function(e) {
    ...
    function(e, t) {
        e.exports = '<div class="content">\r\n  <h1>Flow Control</h1>\r\n\r\n  <p>This interactive animation shows the interaction\r\n    between the sending application, the TCP send buffer, the TCP receive buffer, and the receiving\r\n    application. The receiving application reads chunks of bytes at random times. When the receive\r\n    buffer becomes full, the TCP receiver advertises a receive window of 0. As described in the\r\n    text, the sender then continues to send segments with one byte of data.\r\n  </p>\r\n\r\n  <div class="applet" role="region" title="Application">\r\n    <div class="buttons">\r\n      <button tabindex="0" class="_start" aria-label="Start. Press to start the animation below." role="button">Start</button>\r\n      <button tabindex="0" class="_faster" aria-label="Faster. Press to increase the transmission speed." role="button">Faster</button>\r\n      <button tabindex="0" class="_slower" aria-label="Slower. Press to decrease the transmission speed." role="button">Slower</button>\r\n      <button tabindex="0" class="_reset" aria-label="Reset. Press to stop and reset the animation." role="button">Reset</button>\r\n    </div>\r\n    <div class="comboboxes"></div>\r\n    <div class="canvas">\r\n      <img class="graphic" style="margin: 0; padding: 0"/>\r\n      <canvas role="img" width="600" height="300"><p></p></canvas>\r\n    </div>\r\n  </div>\r\n  <div class="notes text">\r\n    <strong>Notes:</strong>\r\n    <ol>\r\n      <li>Host B consumes data in 2Kbyte chunks at random times.</li>\r\n      <li>When Host A receives an acknowledgment with WIN=0, Host A\r\n        sends a packet with one byte of data. It is assumed for simplicity, that this one byte is\r\n        not comsumed by the receiver.\r\n      </li>\r\n    </ol>\r\n  </div>\r\n</div>\r\n\r\n'
    },
    function(e, t) {
        var n = [4, 8, 16],
            i = [2, 4, 8],
            r = 2,
            o = function() {
                this.setBufferSize(), this.setFileSize(), this.reset()
            };
        o.prototype.setFileSize = function(e) {
            ...
            if (0 === this.sendBuffer && 0 !== this.getSendInsidePart() && this.sentData < this.fileSize) {
                ...
                this.sentData += e, this.sendBuffer = e
            }
            ...
            this.consumeTimout = window.setTimeout(function() {
                this.consumedData !== this.fileSize && 0 !== this.receiveBuffer && (this.receiveBuffer -= r, this.consumedData += r, this.justConsumed = !0, window.setTimeout(function() {
                    this.justConsumed = !1
                }.bind(this), 2e3), 0 != this.receiveBuffer && this.consume())
            }.bind(this), 1e3 + 3e3 * Math.random())
        }, o.prototype.finishSend = function() {
            this.sendInProgress = !1, this.receiveInProgress = !0, 0 !== this.requestedData && (this.receiveBuffer += this.requestedData, this.consume()), !this.isAllRecieved() && this.receiveBuffer < this.bufferSize ? this.requestedData = r : this.requestedData = 0, this.fullSendBuffer()
        }, o.prototype.send = function() {
            this.canSend && 0 != this.requestedData && (this.emptySendBuffer(), this.canSend = !1)
        }, o.prototype.finishReceive = function() {
            this.sendInProgress = !0, this.receiveInProgress = !1, this.isAllSent() && this.isAllRecieved() ? (this.sendInProgress = !1, this.finished = !0) : (this.canSend = !0, this.send())
        }, o.prototype.isFinished = function() {
            return this.finished && this.isAllConsumed()
        }, o.prototype.reset = function() {
            this.canSend = !1, this.sendInProgress = !1, this.receiveInProgress = !1, this.finished = !1, this.justConsumed = !1, this.requestedData = this.isBufferSmall() ? this.bufferSize : this.fileSize, this.sentData = 0, this.consumedData = 0, this.sendBuffer = 0, this.receiveBuffer = 0, window.clearTimeout(this.consumeTimout)
        }, e.exports = o
    },
    function(e, t, n, i) {
        var r = n(i);
