! function(e) {
    ...
    function(e, t) {
        e.exports = '<div class="content">\r\n  <h1>Kiểm soát Luồng</h1>\r\n\r\n  <p>Minh họa dưới đây thể hiện sự tương tác\r\n    giữa ứng dụng gửi, bộ đệm gửi TCP, bộ đệm nhận TCP và ứng dụng nhận.\r\n    Ứng dụng nhận đọc các khối dữ liệu vào thời điểm ngẫu nhiên. Khi bộ đệm nhận\r\n    trở nên đầy, bên nhận TCP quảng bá một cửa sổ nhận với giá trị 0. Như đã mô tả, bên gửi sau đó tiếp tục gửi các đoạn với một byte dữ liệu.\r\n  </p>\r\n\r\n  <div class="applet" role="region" title="Ứng dụng">\r\n    <div class="buttons">\r\n      <button tabindex="0" class="_start" aria-label="Bắt đầu. Nhấn để bắt đầu hoạt hình bên dưới." role="button">Bắt đầu</button>\r\n      <button tabindex="0" class="_faster" aria-label="Nhanh hơn. Nhấn để tăng tốc độ truyền." role="button">Nhanh hơn</button>\r\n      <button tabindex="0" class="_slower" aria-label="Chậm hơn. Nhấn để giảm tốc độ truyền." role="button">Chậm hơn</button>\r\n      <button tabindex="0" class="_reset" aria-label="Thiết lập lại. Nhấn để dừng và thiết lập lại hoạt hình." role="button">Thiết lập lại</button>\r\n    </div>\r\n    <div class="comboboxes"></div>\r\n    <div class="canvas">\r\n      <img class="graphic" style="margin: 0; padding: 0"/>\r\n      <canvas role="img" width="600" height="300"><p></p></canvas>\r\n    </div>\r\n  </div>\r\n  <div class="notes text">\r\n    <strong>Ghi chú:</strong>\r\n    <ol>\r\n      <li>Máy chủ B tiêu thụ dữ liệu theo các khối 2Kbyte vào các thời điểm ngẫu nhiên.</li>\r\n      <li>Khi Máy chủ A nhận được một sự xác nhận với WIN=0, Máy chủ A\r\n        gửi một gói tin với một byte dữ liệu. Điều này được giả định để đơn giản hóa, rằng một byte này không được\r\n        tiêu thụ bởi bên nhận.\r\n      </li>\r\n    </ol>\r\n  </div>\r\n</div>\r\n\r\n'
    },
